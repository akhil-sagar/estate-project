            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                ...
                <div className='flex gap-2 items-center'>
                        ...
                        ' onChange={handleChange} defaultValue={'created_at_desc'}>
                            <option value="regluarPrice_desc">Price high to low</option>
                            <option value="regluarPrice_asc">Price low to high</option>
                            <option value="createdAt_desc">Latest</option>
                            <option value="createdAt_asc">Oldest</option>
                        </select>

                </div>
                <button className='bg-slate-700 text-white uppercase 
                rounded-lg border hover:opacity-95 p-3'>Search</button>

...
import { FaBed, FaMapMarkerAlt, FaShare,FaBath,FaParking,FaChair } from 'react-icons/fa';
  ...
  return (
    <main>
            ...
            <div>
                ...
                <div className=' fixed top-[13%] right-[3%] z-10 border w-12 h-12 rounded-full flex 
                ...
                <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-3'>
                    ...
                    className='text-white uppercase bg-slate-700 border rounded-lg 

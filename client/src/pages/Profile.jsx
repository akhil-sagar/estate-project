  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
     ...
     <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
      ...
      onClick={()=>fileRef.current.click()}  src={formData.avatar|| currentUser.avatar} alt="" />
     ...
     <p className='text-red-700 mt-5'>{error ? error:''}</p>
      ...
      <button onClick={handleShowListings} className='text-green-500 w-full'>Show Listing</button>
